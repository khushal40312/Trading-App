...
router.post('/register', [
  ...
  body('otp').isInt().isLength({ min: 6 }).withMessage('OTP must be 6 Charater long and numeric')
...
router.get('/logout/:token', authMiddleware.authUser, userController.logoutUser)
